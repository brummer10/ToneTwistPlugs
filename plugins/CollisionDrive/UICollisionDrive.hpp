/*
 * CollisionDrivee audio effect based on DISTRHO Plugin Framework (DPF)
 *
...
#ifndef UI_COLLISIONDRIVE_H
#define UI_COLLISIONDRIVE_H
...
class UICollisionDrive : public UI
{
public:
    UICollisionDrive();
    ~UICollisionDrive();
...
private:
    ...
    ScopedPointer<CairoKnob> brightKnob;
    ScopedPointer<CairoKnob> attackKnob;
